...
interface SettingsState {
  apiKeys: { deepseek: string; anthropic: string; openai: string; serper: string; resend: string; github: string };
...
const initialState: ChatState = {
  ...
  settings: {
    apiKeys: { deepseek: '', anthropic: '', openai: '', serper: '', resend: '', github: '' }, theme: 'light', language: 'zh-CN', fontSize: 15,

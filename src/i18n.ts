...
const DICT: any = {
  'zh-CN': {
    settings: {
      ...
      lab: {
        title:'实验', dashboard:'仪表盘', diagnostics:'自诊断', benchmark:'跑分台', experiments:'实验历史', sandbox:'沙箱', memory:'记忆库', logs:'日志',
        dashCalls:'API 调用次数', dashTokens:'Token 消耗', dashSessions:'会话数', dashHealth:'健康检查',
        diagTitle:'系统自诊断', diagRefresh:'刷新诊断', diagClick:'点击刷新',
        benchTitle:'性能跑分台', benchDesc:'3道标准优化题，测量准确率和响应时间', benchRun:'开始跑分', benchRunning:'跑分中...', benchLatency:'耗时', benchStatus:'状态', benchOutput:'输出',
        expTitle:'实验历史', expRefresh:'刷新', expEmpty:'暂无实验', expEmptyDesc:'在对话中运行批量实验以查看结果',
        sandTitle:'Python 沙箱', sandRefresh:'刷新状态', sandPkg:'包名 (如 numpy)', sandInstall:'安装', sandInstalling:'安装中...',
        memTitle:'Agent 记忆库', memDesc:'Agent 在对话中自动学习偏好。可手动添加指令。', memPlaceholder:'例如："偏好使用 Gurobi 语法"', memAdd:'添加', memEmpty:'暂无记忆。Agent 会在对话中自动学习。',
        logTitle:'系统日志',
      },
      git: {
        title:'Version Control', esc:'Esc', connectTitle:'连接 GitHub', connectDesc:'登录 GitHub 账号以克隆仓库和管理 PR', connectBtn:'使用 GitHub 登录',
        reposTitle:'你的仓库', filterPlaceholder:'筛选仓库...', loading:'加载中...', noRepos:'无仓库。请检查 GitHub Token 权限。', noMatch:'无匹配"{0}"', clone:'克隆',
        statusBar:'{branch} / {count} 个文件', refresh:'刷新', clean:'工作区干净',
        stagedChanges:'已暂存的更改', commitMsg:'提交信息', commit:'提交', committing:'提交中...', cancel:'取消',
        push:'推送 & PR', pushing:'推送中...', pushOk:'推送成功。创建 PR 中...', pushFail:'推送失败',
        prs:'PRs', issues:'Issues', ci:'CI', noPRs:'无开放的 PR', noIssues:'无开放的 Issue', noRuns:'无最近的运行记录',
        cloneInput:'选择要克隆的仓库',
      },
      login: {
        emailError:'邮箱或密码错误。如果忘记了密码，请点击"忘记密码"重置。',
        alreadyRegistered:'该邮箱已注册。请切换到"登录"标签直接登录。',
        emailNotConfirmed:'邮箱未确认。',
        rateLimit:'请求过于频繁，请稍后再试。',
        passwordShort:'密码至少需要 6 位字符。',
        invalidEmail:'邮箱格式不正确。',
        electronOnly:'请在 Electron 桌面应用中操作。',
        ghOpening:'正在打开浏览器进行 GitHub 授权...',
        ghFailed:'登录失败',
      },
  ...
  'en': {
    settings: {
      ...
      lab: {         title:'Lab', dashboard:'Dashboard', diagnostics:'Diagnostics', benchmark:'Benchmark', experiments:'Experiments', sandbox:'Sandbox', memory:'Memory', logs:'Logs',
        dashCalls:'API Calls', dashTokens:'Tokens Used', dashSessions:'Sessions', dashHealth:'Health Checks',
        diagTitle:'System Diagnostics', diagRefresh:'Refresh', diagClick:'Click Refresh to run diagnostics',
        benchTitle:'Benchmark Suite', benchDesc:'3 standard problems. Measures accuracy and latency.', benchRun:'Run All', benchRunning:'Running...', benchLatency:'Latency', benchStatus:'Status', benchOutput:'Output',
        expTitle:'Experiment History', expRefresh:'Refresh', expEmpty:'No experiments', expEmptyDesc:'Run batch experiments in chat to see results here',
        sandTitle:'Python Sandbox', sandRefresh:'Refresh', sandPkg:'Package name (e.g. numpy)', sandInstall:'Install', sandInstalling:'Installing...',
        memTitle:'Agent Memory', memDesc:'Agent auto-learns from conversations. Add manual instructions.', memPlaceholder:'e.g. "Prefer Gurobi syntax"', memAdd:'Add', memEmpty:'No memories. Agent learns automatically.',
        logTitle:'System Logs', },
      git: {         title:'Version Control', esc:'Esc', connectTitle:'Connect GitHub', connectDesc:'Sign in to clone repos and manage PRs', connectBtn:'Sign in with GitHub',
        reposTitle:'Your Repositories', filterPlaceholder:'Filter repositories...', loading:'Loading...', noRepos:'No repositories. Check token permissions.', noMatch:'No matches for "{0}"', clone:'Clone',
        statusBar:'{branch} / {count} files', refresh:'Refresh', clean:'Working tree clean',
        stagedChanges:'Staged Changes', commitMsg:'Commit message', commit:'Commit', committing:'Committing...', cancel:'Cancel',
        push:'Push & PR', pushing:'Pushing...', pushOk:'Push OK. Creating PR...', pushFail:'Push failed',
        prs:'PRs', issues:'Issues', ci:'CI', noPRs:'No open PRs', noIssues:'No open issues', noRuns:'No recent runs',
        cloneInput:'Select a repository to clone', },
      login: {         emailError:'Invalid email or password.',
        alreadyRegistered:'Email already registered. Switch to Login tab.',
        emailNotConfirmed:'Email not confirmed.',
        rateLimit:'Too many requests. Please wait.',
        passwordShort:'Password must be at least 6 characters.',
        invalidEmail:'Invalid email address.',
        electronOnly:'Please use the Electron desktop app.',
        ghOpening:'Opening browser for GitHub authorization...',
        ghFailed:'Login failed', },
  ...
  'ja': {
    settings: {
      ...
      lab: {
        title:'実験', dashboard:'ダッシュボード', diagnostics:'診断', benchmark:'ベンチマーク', experiments:'実験履歴', sandbox:'サンドボックス', memory:'メモリ', logs:'ログ',
        dashCalls:'APIコール', dashTokens:'トークン使用量', dashSessions:'セッション', dashHealth:'ヘルスチェック',
        diagTitle:'システム診断', diagRefresh:'更新', diagClick:'クリックして診断を実行',
        benchTitle:'ベンチマーク', benchDesc:'3問の標準問題で精度と応答時間を測定', benchRun:'実行', benchRunning:'実行中...', benchLatency:'レイテンシ', benchStatus:'状態', benchOutput:'出力',
        expTitle:'実験履歴', expRefresh:'更新', expEmpty:'まだ実験がありません', expEmptyDesc:'チャットでバッチ実験を実行するとここに表示されます',
        sandTitle:'Pythonサンドボックス', sandRefresh:'更新', sandPkg:'パッケージ名 (例: numpy)', sandInstall:'インストール', sandInstalling:'インストール中...',
        memTitle:'エージェントメモリ', memDesc:'エージェントは会話から自動学習します', memPlaceholder:'例: "Gurobi構文を優先"', memAdd:'追加', memEmpty:'まだ記憶がありません',
        logTitle:'システムログ',
      },
      git: {
        title:'バージョン管理', esc:'Esc', connectTitle:'GitHubに接続', connectDesc:'ログインしてリポジトリをクローン', connectBtn:'GitHubでログイン',
        reposTitle:'リポジトリ', filterPlaceholder:'フィルタ...', loading:'読込中...', noRepos:'リポジトリがありません', noMatch:'未検出 "{0}"', clone:'クローン',
        statusBar:'{branch} / {count} ファイル', refresh:'更新', clean:'変更なし',
        stagedChanges:'ステージング済み', commitMsg:'コミットメッセージ', commit:'コミット', committing:'コミット中...', cancel:'キャンセル',
        push:'プッシュ & PR', pushing:'プッシュ中...', pushOk:'プッシュ完了', pushFail:'プッシュ失敗',
        prs:'PR', issues:'課題', ci:'CI', noPRs:'PRなし', noIssues:'課題なし', noRuns:'実行履歴なし',
        cloneInput:'リポジトリを選択',
      },
      login: {
        emailError:'メールまたはパスワードが間違っています',
        alreadyRegistered:'既に登録済みです。ログインタブに切り替えてください',
        emailNotConfirmed:'メール未確認',
        rateLimit:'リクエストが多すぎます',
        passwordShort:'パスワードは6文字以上必要です',
        invalidEmail:'無効なメールアドレス',
        electronOnly:'Electronアプリで操作してください',
        ghOpening:'ブラウザでGitHub認証を開いています...',
        ghFailed:'ログイン失敗',
      },
  ...
  'fr': {
    settings: {
      ...
      lab: {
        title:'Labo', dashboard:'Tableau', diagnostics:'Diagnostic', benchmark:'Benchmark', experiments:'Experiences', sandbox:'Sandbox', memory:'Memoire', logs:'Journaux',
        dashCalls:'Appels API', dashTokens:'Jetons utilises', dashSessions:'Sessions', dashHealth:'Verifications',
        diagTitle:'Diagnostic systeme', diagRefresh:'Actualiser', diagClick:'Cliquez pour lancer le diagnostic',
        benchTitle:'Benchmark', benchDesc:'3 problemes standard. Mesure precision et latence.', benchRun:'Lancer', benchRunning:'En cours...', benchLatency:'Latence', benchStatus:'Statut', benchOutput:'Sortie',
        expTitle:'Historique', expRefresh:'Actualiser', expEmpty:'Aucune experience', expEmptyDesc:'Executez des experiences dans le chat',
        sandTitle:'Sandbox Python', sandRefresh:'Actualiser', sandPkg:'Nom du paquet (ex: numpy)', sandInstall:'Installer', sandInstalling:'Installation...',
        memTitle:'Memoire Agent', memDesc:'L\'agent apprend automatiquement', memPlaceholder:'ex: "Preferer la syntaxe Gurobi"', memAdd:'Ajouter', memEmpty:'Aucune memoire',
        logTitle:'Journaux systeme',
      },
      git: {
        title:'Controle de version', esc:'Echap', connectTitle:'Connecter GitHub', connectDesc:'Connectez-vous pour cloner des depots', connectBtn:'Se connecter avec GitHub',
        reposTitle:'Vos depots', filterPlaceholder:'Filtrer...', loading:'Chargement...', noRepos:'Aucun depot', noMatch:'Aucun resultat pour "{0}"', clone:'Cloner',
        statusBar:'{branch} / {count} fichiers', refresh:'Actualiser', clean:'Arbre propre',
        stagedChanges:'Modifications indexees', commitMsg:'Message de commit', commit:'Commit', committing:'Commit...', cancel:'Annuler',
        push:'Push & PR', pushing:'Push...', pushOk:'Push OK', pushFail:'Echec du push',
        prs:'PRs', issues:'Tickets', ci:'CI', noPRs:'Aucune PR', noIssues:'Aucun ticket', noRuns:'Aucune execution',
        cloneInput:'Selectionner un depot',
      },
      login: {
        emailError:'Email ou mot de passe invalide.',
        alreadyRegistered:'Email deja enregistre.',
        emailNotConfirmed:'Email non confirme.',
        rateLimit:'Trop de requetes.',
        passwordShort:'Mot de passe: 6 caracteres minimum.',
        invalidEmail:'Adresse email invalide.',
        electronOnly:'Veuillez utiliser l\'application Electron.',
        ghOpening:'Ouverture du navigateur pour autorisation GitHub...',
        ghFailed:'Echec de connexion',
      },
      git: {
        title:'バージョン管理', esc:'Esc', connectTitle:'GitHubに接続', connectDesc:'ログインしてリポジトリをクローン', connectBtn:'GitHubでログイン',
        reposTitle:'リポジトリ', filterPlaceholder:'フィルタ...', loading:'読込中...', noRepos:'リポジトリがありません', noMatch:'未検出', clone:'クローン',
        statusBar:'{branch} / {count} ファイル', refresh:'更新', clean:'変更なし',
        stagedChanges:'ステージング済み', commitMsg:'コミットメッセージ', commit:'コミット', committing:'コミット中...', cancel:'キャンセル',
        push:'プッシュ & PR', pushing:'プッシュ中...', pushOk:'プッシュ完了', pushFail:'プッシュ失敗',
        prs:'PR', issues:'課題', ci:'CI', noPRs:'PRなし', noIssues:'課題なし', noRuns:'実行履歴なし',
...
export function langInstruction(lang: string): string {
  ...
  return map[lang] || map['en'];
      git: {
        title:'Version Control', esc:'Esc', connectTitle:'Connect GitHub', connectDesc:'Sign in to clone repos and manage PRs', connectBtn:'Sign in with GitHub',
        reposTitle:'Your Repositories', filterPlaceholder:'Filter repos...', loading:'Loading...', noRepos:'No repos. Check token permissions.', noMatch:'No match for "{0}"', clone:'Clone',
        statusBar:'{branch} / {count} files', refresh:'Refresh', clean:'Working tree clean',
        stagedChanges:'Staged Changes', commitMsg:'Commit message', commit:'Commit', committing:'Committing...', cancel:'Cancel',
        push:'Push & PR', pushing:'Pushing...', pushOk:'Push OK. Creating PR...', pushFail:'Push failed',
        prs:'PRs', issues:'Issues', ci:'CI', noPRs:'No open PRs', noIssues:'No open issues', noRuns:'No recent runs',
        cloneInput:'Select a repository',
      },
      login: {
      ...
      git: {
        title:'Controle de version', esc:'Echap', connectTitle:'Connecter GitHub', connectDesc:'Connectez-vous pour cloner des depots', connectBtn:'Se connecter avec GitHub',
        reposTitle:'Vos depots', filterPlaceholder:'Filtrer...', loading:'Chargement...', noRepos:'Aucun depot', noMatch:'Aucun resultat', clone:'Cloner',
        statusBar:'{branch} / {count} fichiers', refresh:'Actualiser', clean:'Arbre propre',
        stagedChanges:'Modifications indexees', commitMsg:'Message de commit', commit:'Commit', committing:'Commit...', cancel:'Annuler',
        push:'Push & PR', pushing:'Push...', pushOk:'Push OK', pushFail:'Echec du push',
        prs:'PRs', issues:'Tickets', ci:'CI', noPRs:'Aucune PR', noIssues:'Aucun ticket', noRuns:'Aucune execution',
      ...
      login: {
        ...
        emailNotConfirmed:'Email non confirme.',
        rateLimit:'Trop de requetes.',
        passwordShort:'6 caracteres minimum.',
        invalidEmail:'Adresse email invalide.',
        electronOnly:'Utilisez l\'application Electron.',
        ghOpening:'Ouverture du navigateur pour autorisation GitHub...',
        ghFailed:'Echec de connexion',
      },
}

...
const DICT: any = {
  'zh-CN': {
    settings: {
      ...
      models: { title:'模型 API', desc:'内置 DeepSeek 免费密钥已包含。添加你自己的 API Key 以解锁更多模型。', deepseekNote:'V3 / R1 模型', anthropicNote:'Claude Sonnet / Opus', openaiNote:'GPT-4o / o1', serperNote:'联网搜索 API', deepseekPlaceholder:'已内置 · 可覆盖' },

...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  skillRegistryList: () => ipcRenderer.invoke('skillregistry:list'),
  resultAnalyze: (p) => ipcRenderer.invoke('result:analyze', p),
  trainingList: () => ipcRenderer.invoke('training:list'),
  trainingRun: (id) => ipcRenderer.invoke('training:run', { id }),
  onTrainingLog: (cb) => { ipcRenderer.on('training:log', (_, d) => cb(d)); },
  onAgentSwitch: (cb) => { ipcRenderer.on('polaris:agent-switch', (_, d) => cb(d)); },
